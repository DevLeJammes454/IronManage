...
const addToCart = (data) => {
    ...
    setCart([...cart, { ...data, name: material.name, bars: calculateBars(data.linear_meters), cost: calculateBars(data.linear_meters) * (isZintro ? Number(material.price_zintro) : Number(material.price_black)), id: Date.now() }]);
    reset();
};
